...
timeaxtics <- seq(as.POSIXct("2021-07-01"), as.POSIXct("2023-12-01") , by = "month")
axis(1, at = c(timeaxtics,as.POSIXct("2023-12-31 12:00:00")), labels = FALSE)
par(mgp = c(2.5, 0.4, 0))
axis.POSIXct(1, at = timeaxtics + 15*24*60*60, tcl = 0, cex.axis = 0.8, format = "%b")
par(mgp = c(2.5, 1.6, 0))
axis.POSIXct(1, at = as.POSIXct(c("2021-11-15", "2022-06-30", "2023-06-30")), tcl = 0, cex.axis = 0.8, format = "%Y")
